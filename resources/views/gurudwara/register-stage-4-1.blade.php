            ...
            <div class="row justify-content-center">
                <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform" name="msform" method="POST" action="{{route('gurudwara.registerstep41confirm')}}" autocomplete="off">
                            @csrf
                            <input type="text" hidden name="register_stage" id="register_stage" value="41"/>
                            <!-- progressbar -->
                            <!-- <ul id="progressbar">
                            ...
                            <fieldset>
                                ...
                                <div class="form-card">
                                    ...
                                    <label class="fieldlabels">Gurdwara Head Home Address : *</label> 
                                    <textarea required name="gurudwara_head_home_address" id="gurudwara_head_home_address" value="" rows="3" placeholder="Home Address">{{isset($editdata->gurudwara_head_home_address)?$editdata->gurudwara_head_home_address:''}}</textarea>
                                    <label class="fieldlabels">Gurdwara Head Job Address : *</label> 
                                    <textarea required name="gurudwara_head_job_address" id="gurudwara_head_job_address" value="" rows="3" placeholder="Job Address">{{isset($editdata->gurudwara_head_job_address)?$editdata->gurudwara_head_job_address:''}}</textarea>
                                    <label class="fieldlabels">Gurdwara Head Position : *</label> 
                                    <input required type="text" name="gurudwara_head_position" id="gurudwara_head_position" value="{{isset($editdata->gurudwara_head_position)?$editdata->gurudwara_head_position:''}}" placeholder="Position" /> 
                                    <label class="fieldlabels">Gurdwara Head Phone No : *</label> 
                                    <input required type="number" name="gurudwara_head_phone_no" id="gurudwara_head_phone_no" value="{{isset($editdata->gurudwara_head_phone_no)?$editdata->gurudwara_head_phone_no:''}}" placeholder="Phone No" /> 
                                    <label class="fieldlabels">Gurdwara Head Email Id : *</label> 
                                    <input required type="email" name="gurudwara_head_email" id="gurudwara_head_email" value="{{isset($editdata->gurudwara_head_email)?$editdata->gurudwara_head_email:''}}" placeholder="Email Id" />  
                                

                                   
                                </div> 
                                <input type="Submit" name="step1" id="step1" data-attribute="step1" class="action-button" value="Save & Continue" />
                                <input type="button" name="previous" class="action-button" value="Previous" onclick="location.href='{{route('gurudwara.registerstep4')}}'"/>
