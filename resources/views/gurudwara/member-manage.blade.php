                ...
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$gurudwaras->designation}}</td>
                      <td id="actionTd{{$gurudwaras->id}}">
                        <a href="{{route('gurudwara.editmember',['id' => Crypt::encryptString($gurudwaras->id)])}}" id="accept" ><i class="fas fa-edit"></i></a>
                      </td>
                    </tr>
                    @endforeach
                  <!-- <tr>
