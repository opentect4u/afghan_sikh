        ...
        <div class="row">
          <div class="col-lg-3 col-md-3" data-aos="fade-up">
            <div class="icon-box">
			  ...
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=FINANCE" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="100">
            <div class="icon-box">
              ...
              <p class="description">Voluptatum deleniti atque corrupti quos dolores</p>
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=FAMILY DISPUTES" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="200">
            <div class="icon-box">
			  ...
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=MARRIAGES ISSUES" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="300">
            <div class="icon-box">
             <div class="icon"><i><img src="{{ asset('public/img/4.png') }}" alt=""></i></div>
			  ...
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=RELIGIOUS ISSUE" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="400">
            <div class="icon-box">
             <div class="icon"><i><img src="{{ asset('public/img/5.png') }}" alt=""></i></div>
			  ...
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=REUNION FAMILY" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
          <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
             <div class="icon"><i><img src="{{ asset('public/img/6.png') }}" alt=""></i></div>
			  ...
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=PROPERTY DISPUTE" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
		   <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="500">
            <div class="icon-box">
              ...
              <p class="description">Et harum quidem rerum facilis est et expedita</p>
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=DIVORCE DISPUTE" class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
		   <div class="col-lg-3 col-md-3" data-aos="fade-up" data-aos-delay="500">
          ...
          <div class="icon"><i><img src="{{ asset('public/img/8.png') }}" alt=""></i></div>
              ...
              <p class="description">Et harum quidem rerum facilis est et expedita</p>
			  <div class="btn-wrap">
                <a href="{{route('user.servicesregister')}}?purpose=OTHER " class="btn-buy">Apply Now</a>
              </div>
            </div>
          </div>
        </div>
