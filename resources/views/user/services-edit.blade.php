                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <!-- <input type="text" required name="first_name" value="{{isset($data)? $data->first_name:''}}" class="form-control" > -->
                        ...
                        <!-- <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="middle_name" value="{{isset($data)? $data->middle_name:''}}" class="form-control" >
                            </div>
                        </div> -->
                        ...
                        <div class="col-sm-5">
                            <div class="form-group">
                               <label class="fieldlabels"> Document 1 : * (.jpeg/.jpg/.png/.pdf, max size 2mb)</label> 
                                ...
                                @endif
                                <input type="file" <?php if(isset($data) && $data->doc_1!=''){echo "";}else{echo "required";}?> name="doc_1" id="doc_1" class="form-control" accept="image/gif, image/jpg, image/jpeg, application/pdf" />
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            ...
                            <div class="form-group">
                               <label class="fieldlabels"> Document 2 : * (.jpeg/.jpg/.png/.pdf, max size 2mb)</label> 
                                ...
                                @endif
                                <input type="file" <?php if(isset($data) && $data->doc_2!=''){echo "";}else{echo "required";}?> name="doc_2" id="doc_2" class="form-control" accept="image/gif, image/jpg, image/jpeg, application/pdf" />
                            </div>
                        </div>
                        <div class="col-sm-6" >
                            <!-- text input -->
                    ...
                    <div class="row" id="uploadDiv6" data-upload-div-value="0">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="doc_6_name" id="doc_6_name" value="{{isset($data)?$data->doc_6_name:''}}" class="form-control" placeholder="Document 6 Name" />
                            </div>
                        </div>
                    ...
                    <div class="row" id="uploadDiv7" data-upload-div-value="0">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="doc_7_name" id="doc_7_name" value="{{isset($data)?$data->doc_7_name:''}}" class="form-control" placeholder="Document 7 Name" />
                    ...
                    <div class="row" id="uploadDiv8" data-upload-div-value="0">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="doc_8_name" id="doc_8_name" value="{{isset($data)?$data->doc_8_name:''}}" class="form-control" placeholder="Document 8 Name" />
                            </div>
                        </div>
                    ...
                    <div class="row" id="uploadDiv9" data-upload-div-value="0">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="doc_9_name" id="doc_9_name" value="{{isset($data)?$data->doc_9_name:''}}" class="form-control" placeholder="Document 9 Name" />
                            </div>
                        </div>
                    ...
                    <div class="row" id="uploadDiv10" data-upload-div-value="0">
                        ...
                        <div class="col-sm-6" >
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="doc_10_name" id="doc_10_name" value="{{isset($data)?$data->doc_10_name:''}}" class="form-control" placeholder="Document 9 Name" />
                            </div>
                        </div>
...
<script>
    ...
    var uploadDiv2='<?php if(isset($data) && $data->doc_2){echo $data->doc_2;}?>';
    var uploadDiv3='<?php if(isset($data) && $data->doc_3){echo $data->doc_3;}?>';
    var uploadDiv4='<?php if(isset($data) && $data->doc_4){echo $data->doc_4;}?>';
    var uploadDiv5='<?php if(isset($data) && $data->doc_5){echo $data->doc_5;}?>';
    var uploadDiv6='<?php if(isset($data) && $data->doc_6){echo $data->doc_6;}?>';
    var uploadDiv7='<?php if(isset($data) && $data->doc_7){echo $data->doc_7;}?>';
    var uploadDiv8='<?php if(isset($data) && $data->doc_8){echo $data->doc_8;}?>';
    var uploadDiv9='<?php if(isset($data) && $data->doc_9){echo $data->doc_9;}?>';
    var uploadDiv10='<?php if(isset($data) && $data->doc_10){echo $data->doc_10;}?>';
    // alert(uploadDiv2);
    if(uploadDiv2==''){
        $('#uploadDiv2').hide();
    }
