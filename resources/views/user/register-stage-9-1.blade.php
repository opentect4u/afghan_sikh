            ...
            <div class="row justify-content-center">
                <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform" name="msform" method="POST" action="{{route('user.registerstep91confirm')}}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            <input type="text" hidden name="register_stage" id="register_stage" value="91"/>
                            <!-- progressbar -->
                            <!-- <ul id="progressbar">
