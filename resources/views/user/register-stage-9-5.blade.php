            ...
            <div class="row justify-content-center">
                <div class="col-11 col-sm-9 col-md-7 col-lg-6 col-xl-5 text-center p-0 mt-3 mb-2">
                    <div class="card px-0 pt-4 pb-0 mt-3 mb-3">
                        ...
                        <form id="msform" name="msform" method="POST" action="{{route('user.registerstep95confirm')}}" autocomplete="off" enctype="multipart/form-data">
                            @csrf
                            ...
                            <fieldset>
                                ...
                                <div class="form-card">
                                    ...
                                    <!-- <br/> -->
                                    <label class="fieldlabels">Add Anather Family Member</label>
                                    <br/> 
                                    <label class="fieldlabels"><a href="{{route('user.addanathermember')}}" style="color:#ffa716;"><i class="fa fa-plus" aria-hidden="true"></i> Add another member</a></label> 

                                    
                                                                       
                                </div> 
                                <input type="Submit" name="step1" id="step1" data-attribute="step1" class="action-button" value="Save & Continue" />
                                <input type="button" name="previous" class="action-button" value="Previous" onclick="location.href='{{route('user.registerstep94')}}'"/>
