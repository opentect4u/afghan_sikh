                            ...
                            <fieldset>
                                ...
                                <div class="form-card">
                                    ...
                                    <div id="uploadDiv1" >
                                        ...
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_1}}" width="100" height="100" />
                                        @endif
                                        <input type="file" name="gurudwara_doc_1" <?php if(isset($editdata) && $editdata->doc_1==''){echo "required";}?> id="gurudwara_doc_1" />
                                        <label class="fieldlabels">Upload Document 1 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_1_name" required id="gurudwara_doc_1_name" value="{{isset($editdata)?$editdata->doc_1_name:''}}" placeholder="Upload Document 1 Name" />
                                    </div>
                                    <div id="uploadDiv2" data-upload-div-value="0">
                                        ...
                                        <input type="text" name="gurudwara_doc_2_name"  id="gurudwara_doc_2_name" value="{{isset($editdata)?$editdata->doc_2_name:''}}" placeholder="Upload Document 2 Name" />
                                    ...
                                    <div id="uploadDiv3" data-upload-div-value="0">
                                        ...
                                        <input type="text" name="gurudwara_doc_3_name"  id="gurudwara_doc_3_name" value="{{isset($editdata)?$editdata->doc_3_name:''}}" placeholder="Upload Document 3 Name" />
                                    ...
                                    <div id="uploadDiv4" data-upload-div-value="0">
                                        ...
                                        <input type="text" name="gurudwara_doc_4_name"  id="gurudwara_doc_4_name" value="{{isset($editdata)?$editdata->doc_4_name:''}}" placeholder="Upload Document 4 Name" />
                                    ...
                                    <div id="uploadDiv5" data-upload-div-value="0">
                                        ...
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_5}}" width="100" height="100" />
                                        @endif
                                        <input type="file" name="gurudwara_doc_5" id="gurudwara_doc_5" />
                                        <label class="fieldlabels">Upload Document 5 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_5_name" id="gurudwara_doc_5_name" value="{{isset($editdata)?$editdata->doc_5_name:''}}" placeholder="Upload Document 5 Name" />
                                    ...
                                    <div id="uploadDiv6" data-upload-div-value="0">
                                        ...
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_6}}" width="100" height="100" />
                                        @endif
                                        <input type="file" name="gurudwara_doc_6" id="gurudwara_doc_6" />
                                        <label class="fieldlabels">Upload Document 6 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_6_name" id="gurudwara_doc_6_name" value="{{isset($editdata)?$editdata->doc_6_name:''}}" placeholder="Upload Document 6 Name" />
                                    ...
                                    <div id="uploadDiv7" data-upload-div-value="0">
                                        ...
                                        @if(isset($editdata) && $editdata->doc_7!='')
                                        </br>
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_7}}" width="100" height="100" />
                                        @endif
                                        <input type="file" name="gurudwara_doc_7" id="gurudwara_doc_7" />
                                        <label class="fieldlabels">Upload Document 7 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_7_name" id="gurudwara_doc_7_name" value="{{isset($editdata)?$editdata->doc_7_name:''}}" placeholder="Upload Document 7 Name" />
                                    ...
                                    <div id="uploadDiv8" data-upload-div-value="0">
                                        ...
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_8}}" width="100" height="100" />
                                        @endif 
                                        <input type="file" name="gurudwara_doc_8" id="gurudwara_doc_8" />
                                        <label class="fieldlabels">Upload Document 8 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_8_name" id="gurudwara_doc_8_name" value="{{isset($editdata)?$editdata->doc_8_name:''}}" placeholder="Upload Document 8 Name" />
                                    ...
                                    <div id="uploadDiv9" data-upload-div-value="0">
                                        ...
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_9}}" width="100" height="100" />
                                        @endif
                                        <input type="file" name="gurudwara_doc_9" id="gurudwara_doc_9" />
                                        <label class="fieldlabels">Upload Document 9 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_9_name" id="gurudwara_doc_9_name" value="{{isset($editdata)?$editdata->doc_9_name:''}}" placeholder="Upload Document 9 Name" />
                                    ...
                                    <div id="uploadDiv10" data-upload-div-value="0">
                                        ...
                                        <img src="{{asset('public/user-doc').'/'.$editdata->doc_10}}" width="100" height="100" />
                                        @endif
                                        <input type="file" name="gurudwara_doc_10" id="gurudwara_doc_10" />
                                        <label class="fieldlabels">Upload Document 10 Name: *</label> 
                                        <input type="text" name="gurudwara_doc_10_name" id="gurudwara_doc_10_name" value="{{isset($editdata)?$editdata->doc_10_name:''}}" placeholder="Upload Document 10 Name" />
                                ...
                                <input type="button" name="previous" class="action-button" value="Previous" onclick="location.href='{{route('user.registerstep8')}}'"/>
