          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                ...
                <a href="{{route('user.addfamilymember')}}" float="right" class="btn btn-outline-primary float-right">Add Member</a>
              </div>
              <!-- <div class="card-header">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{$count++}}</td>
                      <td>{{$gurudwaras->first_name.' '.$gurudwaras->middle_name.' '.$gurudwaras->last_name}} </td>
